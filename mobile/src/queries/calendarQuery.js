...
// changes made elsewhere. Events are applied surgically (`applyCalendarEvent`):
// a delete patches the loaded ranges with no network, a create/update fetches
// just that row. `queryKey` is the blunt fallback on a reconnect gap. Mount once
// near the calendar screen root.
