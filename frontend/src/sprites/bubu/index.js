...
const palette = {
	...
	T: "#e76f8a", // mouth
	C: "#39c5bb", // collar (teal, with a little bell energy)
};
...
// Walk: 4-frame diagonal trot — each diagonal pair swings forward (lifted) while
// the other stays planted, with a neutral contact frame between steps.
const walkLegs = [
...
// Gallop: 2-frame run used by the loading spinner.
const gallopLegs = [
	["..B.B.....B.B...", "..B.B.......B.B."],
	["....B.B...B.B...", "....B.B..B.B...."],
];
